...
let blogObject = [
  {"title":"SoftBank Bets Big on Activewear Maker Vuori","blurb":"SoftBank Group Corp's venture capital fund invested $400 million in Vuori Inc, the California-based maker of leggings and sports bras. Activewear makers have been strong performers over the past year, as millions of people stuck at home have joined the home-fitness bandwagon.","tags":[],"image":"https://miro.medium.com/max/700/0*n_yrdNXwQ-p43iB6","isPublished":true,"_id":"5ebadc66731a3f04b686c297","author":{"fullName":"Michael Grant Warshowsky","_id":"5eba2935c9e191400fe778d4","id":"5eba2935c9e191400fe778d4"},"publishedAt":"2020-05-12T17:27:23.373Z","id":"5ebadc66731a3f04b686c297"},
  {"title":"SoftBank Bets Big on Activewear Maker Vuori","blurb":"SoftBank Group Corp's venture capital fund invested $400 million in Vuori Inc, the California-based maker of leggings and sports bras. Activewear makers have been strong performers over the past year, as millions of people stuck at home have joined the home-fitness bandwagon.","tags":[],"image":"https://miro.medium.com/max/700/0*n_yrdNXwQ-p43iB6","isPublished":true,"_id":"5ebadc66731a3f04b686c297","author":{"fullName":"Michael Grant Warshowsky","_id":"5eba2935c9e191400fe778d4","id":"5eba2935c9e191400fe778d4"},"publishedAt":"2020-05-12T17:27:23.373Z","id":"5ebadc66731a3f04b686c297"},
...
let blogRequest2 = JSON.parse(
  httpGet(`https://api.wolf.financial/v1/blog-posts/${blogObject[0].id}`)
);
if (blogRequest2.success) {
  article = blogRequest2.payload.blogPost;
} else {
  alert("failed to load content!");
}
*/
  ...
  if (i == 0) {
    template = `
        <a href = 'article.html?id=${post.id}'>
            ...
            <div class = 'info'>
                <h1> ${post.title} </h1>
                <h3> ${post.blurb.substr(
                  post.blurb.indexOf(": ") + 1,
                  post.blurb.length
                )} <span class = 'date'> ${post.publishedAt.substring(
      0,
      10
    )} </span> </h3>
            </div>
